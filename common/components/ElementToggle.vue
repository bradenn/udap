...
<template>
  <Element :accent="props.accent" :cb="props.cb" :foreground="true" :long-cb="props.longCb" :to="props.to"
           class="d-flex justify-content-between align-items-center flex-row " style="height: 3.5rem">
    ...
    <div class="d-flex align-items-center">
      ...
      <div>
        <div v-if="props.selected" class="sf d-flex align-items-center justify-content-center label-o3"
             style="width: 3rem !important; margin-right: -4px !important;">
          􀁣
        </div>
        <div v-else class="sf d-flex align-items-center justify-content-center label-o3"
             style="width: 3rem !important; margin-right: -4px !important;">
          􀀀
        </div>
      </div>
