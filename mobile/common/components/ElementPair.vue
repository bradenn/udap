...
<template>
  <Element :cb="props.cb" :foreground="true" :long-cb="props.cb" :mutable="!(!props.cb) || false" :to="props.to"
    ...
    <div class="d-flex justify-content-between align-items-center flex-row" style="height: 2.25rem">
      ...
      <div class="d-flex align-items-center">
        ...
        <div v-if="props.copyable">
          <Element :cb="copyValue" class="sf d-flex align-items-center justify-content-center label-o3" foreground
                   mutable
