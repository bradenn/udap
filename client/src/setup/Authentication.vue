...
import {Attr, Preference} from "../preferences.ts"
...
let controller = new Preference(Attr.Controller).get()
...
function authenticate() {
  ...
  axios.get(url).then(res => {
    ...
    new Preference(Attr.Token).set(res.data.token)
...
<template>
  ...
  <div class="container">
    ...
    <SimpleKeyboard :input="enterChar" keyset="alpha-numeric"></SimpleKeyboard>
  </div>
