...
import TempSlider from "@/components/thermostat/TempSlider.vue";
...
<template>
  <div class="d-flex flex-column gap-1 element">

    <div v-if="true" class="py-1 subplot" style="width: 100%">
    ...
    <div class="d-flex justify-content-between align-items-center gap-1 ">
      <div class="subplot d-flex justify-content-center align-items-center" style="width: 4rem; height: 2rem"
           @click="(e) => setCool(-0.5)">􀆈
      </div>
      <div class="subplot flex-grow-1 d-flex flex-column align-items-center justify-content-center gap-0"
           style="height: 2rem">
        <div class="label-cn2 label-w600 lh-1">{{ state.set.cool }}&deg; F</div>
        <div v-if="state.mode === 'COOL'" class="label-c4 label-w700 label-o5"
