  ...
  <div class="pane-pop-up element p-1 pt-1">
    <div v-if="props.title" class="popup-nav">
      <div class="nav-area justify-content-start">
        <div class="d-flex gap-1 label-o3 px-2 align-items-center label-shimmer" @click="(e) => props.close()">
      ...
      <div class="nav-area justify-content-end">
        <div class="subplot subplot-button subplot-inline subplot-primary" @click="(e) => props.close()">Cancel</div>
