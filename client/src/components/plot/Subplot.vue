...
<template>
  <div v-if="props.to"
    ...
    <div class="d-flex justify-content-start px-1">
      <div v-if="props.icon" class="label-w500 label-o3 label-c1"><i
          :class="`fa-solid fa-${props.icon} fa-fw`"></i>
      </div>
      <div v-else-if="props.sf" class="label-w500 label-o3 label-c1">{{
          props.sf
        }}
      </div>
  ...
  <div v-else-if="props.fn"
       ...
       @mousedown="runFn">
    <div
        :class="`${props.alt?'justify-content-between w-100':'justify-content-center w-100'}`"
        class="d-flex ">
      <div v-if="props.icon" class="label-w500 label-o3 label-c1"><i
          :class="`fa-solid fa-${props.icon} fa-fw`"></i>
      </div>
      <div v-if="sf" v-html="sf"></div>
      <div class="label-w500 label-c1 px-2 label-o4 text-center">{{
          props.name
        }}
      </div>
      <div v-if="props.alt" class="label-w400 label-o4 label-c1 px-2">
        {{ props.alt }}
      </div>
