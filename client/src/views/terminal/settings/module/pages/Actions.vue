...
<template>
  <div class="element p-1 action mb-1">
    <div class="p-1 pt-0">
      ...
      <div class="label-c2 label-o2 label-w400 lh-1">Enable or disable the module depending on if it is needed.<br>
    ...
    <div class="d-flex" style="max-height: 1.6rem; min-width: 6rem">
      <Confirm v-if="!state.module.enabled" :fn="() => toggleEnabled(state.module.id, !state.module.enabled)" icon="􀊃"
               title="Enable"></Confirm>
      <Confirm v-if="state.module.enabled" :fn="() => toggleEnabled(state.module.id, !state.module.enabled)" icon="􀆧"
