...
import type {Module, Timing} from "@/types";
      ...
      <div class="module-container">
        ...
        <Plot v-for="(module, index) in state.modules" :key="module.id"
          ...
          <div class="subplot subplot-inline px-0">
            ...
            <div class="w-100">
              <div>
                ...
                <div class="label-c4  label-o3 label-r py-0 overflow-ellipse"
          ...
          <div class="d-flex gap-1 text-success justify-content-center">
            <Confirm v-if="!module.enabled"
                     :fn="() => toggleEnabled(module.id, !module.enabled)"
                     icon="􀊃"
            ...
            <Radio :active="false" :fn="() => reloadModule(module.name)" sf="􀅉"
                   style="width: 3rem;"
                   title=""></Radio>
            <Radio :active="false" :fn="() => editModule(module.id)" sf="􀍟"
                   style="width: 3rem;"
                   title=""></Radio>
          </div>
        </Plot>
...
.module-container > * {
  visibility: hidden;
  animation: plot-load 100ms ease-in-out forwards !important;
}
