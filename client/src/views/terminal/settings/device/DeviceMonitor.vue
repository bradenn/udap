...
import type {Compute, Device, Utilization} from "@/types";
            ...
            <div class="d-flex flex-column gap-1">
                <Plot v-for="gpu in state.util.compute" v-if="state.util.compute"
                    ...
                    <div class="d-flex w-100 gap-1 h-100">
                        ...
                        <Meter :alt="`${gpu.memory.used + gpu.memory.reserved} MiB / ${gpu.memory.total} MiB`"
                               :danger="90"
                ...
                <Plot v-for="gpu in state.util.compute" v-if="state.util.compute" :cols="1" :rows="2"
                      title="GPU Clocks">
                    <div class="d-flex w-100 gap-1 h-100">
