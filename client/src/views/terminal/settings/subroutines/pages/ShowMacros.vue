...
const notifications = core.notify()
...
function finish(tasks: Task[]) {
  ...
  subroutineService.updateSubroutine({
    ...
    notifications.success("Subroutine", `Updated subroutine '${name.value}' successfully.`)
  }).catch(err => {
    notifications.fail("Subroutine", "Failed to update subroutine '${name.value}'.", err)
  })
      ...
      <div v-if="state.loaded" class="context-pane  d-flex flex-column" style=""
        ...
        <div class="nav-grid gap-1 pb-1 w-100 px-2">
          ...
          <div class="d-flex justify-content-center">
            <div class="label-w500 label-c1 label-w600 align-self-center">
              {{ props.subroutine.description }}
            </div>
          </div>
