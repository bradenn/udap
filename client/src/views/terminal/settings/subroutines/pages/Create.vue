...
import type {Macro, SubRoutine, Task, TaskOption} from "@/types";
        ...
        <div class="context-grid">
            <div class="d-flex justify-content-center h-100 w-100"
                ...
                <div class="generic-grid h-100" @click.stop>
                    <div>
                        <Page :done="() => {goBack()}" :save="() => {finish(state.tasks)}"
                              title="New Subroutine"></Page>

                        <TaskManager :on-complete="finish" :tasks="state.tasks" :title="`Macro`"
